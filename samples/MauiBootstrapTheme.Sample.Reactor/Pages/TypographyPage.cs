    ...
    public override VisualNode RenderContent()
        => ScrollView(
            VStack(spacing: 24,
                // Page Header
                VStack(spacing: 4,
                    Label("Typography").Class("h1"),
                    Label("Bootstrap typography utilities").Class("lead")
                ),
                ...
                // Headings
                VStack(spacing: 12,
                    Label("Headings").Class("h4"),
                    Card(
                        VStack(spacing: 8,
                            Label("Heading 1 (h1)").Class("h1"),
                            Label("Heading 2 (h2)").Class("h2"),
                            Label("Heading 3 (h3)").Class("h3"),
                            Label("Heading 4 (h4)").Class("h4"),
                            Label("Heading 5 (h5)").Class("h5"),
                            Label("Heading 6 (h6)").Class("h6")
                        )
                    )
                ),
                ...
                // Text Styles
                VStack(spacing: 12,
                    Label("Text Styles").Class("h4"),
                    Card(
                        VStack(spacing: 8,
                            Label("This is lead text - larger and lighter for introductory content.").Class("lead"),
                ...
                VStack(spacing: 12,
                    ...
                    Card(
                        VStack(spacing: 12,
                            ...
                            Label("Badge with Text").Class("h6"),
                            HStack(spacing: 8,
