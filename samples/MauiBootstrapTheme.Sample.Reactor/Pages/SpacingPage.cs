            ...
            VStack(spacing: 20,
                ...
                Card(
                    VStack(spacing: 8,
                        ...
                        VStack(spacing: 12,
                            Border(Label("d-grid gap-3 item 1")).Background(Color.FromArgb("#f8f9fa")).Padding(8),
                            Border(Label("d-grid gap-3 item 2")).Background(Color.FromArgb("#f8f9fa")).Padding(8)
                        )
                    )
                )
            ).Padding(20)
